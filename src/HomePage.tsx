      ...
      <main className="max-w-[1000px] mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-7">
          ...
          >
            ...
            <img src='../public/assets/exercise.png' alt="Exercise" className="pr-2 w-28 h-52" />
          </div>
          ...
          >
            ...
            <img src='../public/assets/diet.png' alt="Diet" className="pt-2 w-56 h-48" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <img src='../public/assets/profile.png' alt="Profile" className="mt-4 w-28 h-28" />
          </div>
          ...
          >
            ...
            <img src='../public/assets/pencil.png' alt="Diary" className="mt-8 w-20 h-20" />
          </div>
          ...
          >
            ...
            <div className="text-left flex items-start justify-between">
              ...
              <img src='../public/assets/diaryhistory.png' alt="Diary History" className="w-20 h-20" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="flex justify-center gap-4">
            ...
            >
              <img src='../public/assets/facebook.png' alt="Facebook" className="w-8 h-8" />
            </button>
            <button
              onClick={() => window.open('https://instagram.com', '_blank')}
              className="p-2 hover:bg-gray-100 rounded-full transition-colors"
            >
              <img src='../public/assets/instagram.png' alt="Instagram" className="w-8 h-8" />
            </button>
            <button
              onClick={() => window.open('https://wa.me/201559779813', '_blank')}
              className="p-2 hover:bg-gray-100 rounded-full transition-colors"
            >
              <img src='../public/assets/whatsapp.png' alt="WhatsApp" className="w-8 h-8" />
            </button>
          </div>
        </div>
      </main>
